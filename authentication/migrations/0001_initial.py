    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'مريض'), ('doctor', 'طبيب'), ('receptionist', 'موظف استقبال'), ('admin', 'مدير')], default='patient', max_length=20, verbose_name='الدور')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialty', models.CharField(blank=True, max_length=150, verbose_name='التخصص')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_id', models.CharField(blank=True, max_length=30, verbose_name='الرقم الوطني')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='receptionist_profile', to=settings.AUTH_USER_MODEL, verbose_name='المستخدم')),
            ],
            options={
